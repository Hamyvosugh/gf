...
class GregorianToPadeshahi {

    const PADESHAHI_YEAR_OFFSET = 1180;
    ...
    public static function formatPadeshahiDate($jy, $jm, $jd, $weekday) {
        $month_name = self::getJalaaliMonthName($jm);
        return "$weekday $jd $month_name $jy شاهنشاهی";
    }
}