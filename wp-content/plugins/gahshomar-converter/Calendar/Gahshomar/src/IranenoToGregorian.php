...
class IranenoToGregorian {

    const IRANENO_YEAR_OFFSET = -1396;
    ...
    public static function convert($iy, $im, $id) {
        $jy = $iy - self::IRANENO_YEAR_OFFSET;
        list($gy, $gm, $gd) = JalaaliToGregorian::convert($jy, $im, $id);
        return [$gy, $gm, $gd];
    }
