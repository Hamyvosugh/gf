...
{
    // Chinese Zodiac related data and methods
    ...
    public static function getChineseZodiacAnimal($year)
    {
    ...
    public static function getChineseZodiacElement($year)
    {
        ...
        return self::$chinese_zodiac_elements[(int)($element_index / 2)];
    }

    // Hindu Year related data and methods
    ...
    // Birthstones related data and methods
    ...
    // Western Zodiac related data and methods
    ...
    // Zoroastrian Day Names related data and methods
