...
class ZartoshtiToGregorian {

    const ZARTOSHTI_YEAR_OFFSET = 2359;
    ...
    public static function convert($zy, $zm, $zd) {
        $jy = $zy - self::ZARTOSHTI_YEAR_OFFSET;
        list($gy, $gm, $gd) = JalaaliToGregorian::convert($jy, $zm, $zd);
        return [$gy, $gm, $gd];
    }
