...
class Elementor_Jalaali_Date_Widget extends Widget_Base {

    public function get_name() {
        return 'jalaali_date_widget';
    }

    public function get_title() {
        return __('Jalaali Date Widget', 'gahshomar-converter');
    }
    ...
    protected function render() {
        ...
        ?>
        <div id="jalaali-date-wrapper">
            <h3><?php _e('Jalaali Date', 'gahshomar-converter'); ?></h3>
            <form id="gahshomar-converter-form">
                ...
                <input type="hidden" id="source_calendar" name="source_calendar" value="jalaali">
                <input type="hidden" id="target_calendar" name="target_calendar" value="gregorian">

                <button type="submit"><?php _e('Convert', 'gahshomar-converter'); ?></button>
            </form>
            <div id="jalaali-date-output"></div>
        </div>
        <?php
    }
}